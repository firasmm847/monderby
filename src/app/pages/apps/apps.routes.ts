...
import { AppMatchsComponent } from './matchs/matchs.component';
import { AppBetsComponent } from './bets/bets.component';
import { PlayerComponent } from './player/player.component';
import { BetsfinishedComponent } from './betsfinished/betsfinished.component';
...
export const AppsRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'betsfinished',
        component: BetsfinishedComponent,
        data: {
          title: 'BetsFinished',
          urls: [
            { title: 'Dashboard', url: '/dashboards/dashboard1' },
