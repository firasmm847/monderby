...
export class AppHorizontalHeaderComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.img = this.userData?.imageUrl ? this.getAvatarlUrl(this.userData.imageUrl) : 'zzzz';
  }
  ...
  getAvatarlUrl(avatar: any){
    return avatar ? environment.API_BASE_URL+avatar : '/assets/images/profile/user-1.jpg"';
  }
